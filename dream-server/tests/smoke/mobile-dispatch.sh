...
grep -q "chat-agent" installers/mobile/ios-ashell-cli.sh
grep -q "DREAM_MOBILE_EMAIL_SHORTCUT_NAME" installers/mobile/ios-ashell-install.sh
grep -q "One-tap Email Shortcut" docs/IOS-ASHELL-SHORTCUTS.md
grep -q "Direct Email Sending" docs/IOS-ASHELL-SHORTCUTS.md
